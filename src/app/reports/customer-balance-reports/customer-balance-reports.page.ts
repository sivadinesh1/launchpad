...
@Component({
    selector: 'app-customer-balance-reports',
    templateUrl: './customer-balance-reports.page.html',
    styleUrls: ['./customer-balance-reports.page.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CustomerBalanceReportsPage implements OnInit {
    @ViewChild('menuTriggerN', { static: true }) menuTriggerN: any;
    @ViewChild(SearchCustomersComponent) child: SearchCustomersComponent;

    customer_balance_array;
    ...
    constructor(
        ...
        this._route.data.subscribe((data) => {
            this.customer_balance_array = data.customer_balance_data.body;
        });
    ...
    search() {
        this._commonApiService
            ...
            .subscribe((data) => {
                this.customer_balance_array = data.body;
                this._cdr.markForCheck();
            });
    }
    ...
    async exportPaymentsReceived() {
        ...
        const reportData = JSON.parse(
            JSON.stringify(this.customer_balance_array)
        );
    ...
    backToReports() {
        this._router.navigate([`/home/reports-home`]);
    }
}
