...
export class CountryPhone {
    ...
    constructor(iso: string, name: string) {
        ...
        const phoneUtil = libphonenumber.PhoneNumberUtil.getInstance();
            ...
            const country_example_number = phoneUtil.getExampleNumberForType(this.iso, PNT.MOBILE);
            ...
            const example_number_formatted = phoneUtil.format(country_example_number, PNF.NATIONAL);
