...
export class AdminDashboardPage implements OnInit {
    ...
    reloadTopClients() {
        this._commonApiService
            .getTopClients({ center_id: this.user_data.center_id, limit: 5 })
            .subscribe((data: any) => {
    ...
    goAllCustomerOutstandingBalance() {
        this._router.navigate([
            `/home/reports/all-customer-outstanding-balance-reports`,
        ]);
    }
    ...
    reloadCenterReceivablesSummary() {
        this._commonApiService
            ...
            .subscribe((data: any) => {
                ...
                this.receivablesByCustomers =
                    this.centerReceivablesSummary.filter(
