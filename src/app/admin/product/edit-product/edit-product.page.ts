...
export class EditProductPage implements OnInit {
    ...
    constructor(
        ...
        this.vendors$ = this._commonApiService.getAllActiveVendors();

        this._cdr.markForCheck();

        this._commonApiService
            .viewProductInfo(_route.snapshot.params.productid)
            .subscribe((data) => {
        ...
        this.submitForm = this._formBuilder.group({
            ...
            center_id: _route.snapshot.params.center_id,
            ...
            hsncode: ['', [patternValidator(HSN_CODE_REGEX)]],
    ...
    setFormValues() {
        ...
        this.submitForm.patchValue({
            purchase_price: this.productinfo.purchase_price,
        });
        this.submitForm.patchValue({ salesprice: this.productinfo.salesprice });
        this.submitForm.patchValue({
            maxdiscount: this.productinfo.maxdiscount,
        });
        this.submitForm.patchValue({
