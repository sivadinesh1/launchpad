...
const routes: Routes = [
...

    {
        ...
        children: [
            ...
            // },
            {
                ...
                loadChildren: () =>
                    import(
                        './sales/search-sale-order/search-sale-order.module'
                    ).then((m) => m.SearchSaleOrderPageModule),
            },
            {
                path: 'search-stock-issues',
                loadChildren: () =>
                    import(
                        './stockissue/search-stock-issues/search-stock-issues.module'
                    ).then((m) => m.SearchStockIssuesPageModule),
            },
...

            {
                ...
                loadChildren: () =>
                    import(
                        './reports/statement-reports/statement-reports.module'
                    ).then((m) => m.StatementReportsPageModule),
            },
            {
...

            {
                ...
                loadChildren: () =>
                    import(
                        './admin/product/view-products/view-products.module'
                    ).then((m) => m.ViewProductsPageModule),
            },

            {
                ...
                loadChildren: () =>
                    import(
                        './admin/product/view-product/view-product.module'
                    ).then((m) => m.ViewProductPageModule),
            },
            ...
            },
            {
                ...
                loadChildren: () =>
                    import(
                        './dashboard/admin-dashboard/admin-dashboard.module'
            ...
            },
            {
                ...
                loadChildren: () =>
                    import(
                        './accounts/accounts-payments/accounts-payments.module'
                    ).then((m) => m.AccountsPaymentsPageModule),
            },
            {
                path: 'vpayments',
                loadChildren: () =>
...

            {
                ...
                loadChildren: () =>
                    ...
                    ).then((m) => m.ProcessEnquiryPageModule),
            },

            {
                path: 'product/edit/:center_id/:productid',
                loadChildren: () =>
                    import(
                        './admin/product/edit-product/edit-product.module'
            ...
            // vendors
            {
                ...
                loadChildren: () =>
                    import(
                        './admin/vendor/view-vendors/view-vendors.module'
                    ).then((m) => m.ViewVendorsPageModule),
            },
            ...
            // customers
            {
                ...
                loadChildren: () =>
                    import(
                        './admin/customer/view-customer/view-customer.module'
                    ).then((m) => m.ViewCustomerPageModule),
            },
                ...
                children: [
                    {
                        ...
                        loadChildren: () =>
                            import(
                                './reports/all-customer-outstanding-reports/all-customer-outstanding-reports.module'
                            ).then(
            ...
            },
            {
                ...
                loadChildren: () =>
                    import(
                        './accounts/customer-accounts-statement/customer-accounts-statement.module'
                    ).then((m) => m.CustomerAccountsStatementPageModule),
            },
            {
                path: 'vpurchase-accounts-statement',
                loadChildren: () =>
                    import(
                        './accounts/vpurchase-accounts-statement/vpurchase-accounts-statement.module'
                    ).then((m) => m.VpurchaseAccountsStatementPageModule),
            },
        ],
    },
    ...
    },
    {
        ...
        loadChildren: () =>
            import(
                './settings/template-settings/template-settings.module'
            ).then((m) => m.TemplateSettingsPageModule),
        outlet: 'settings',
    },
    {
        path: 'bank-settings',
        loadChildren: () =>
            import('./settings/bank-settings/bank-settings.module').then(
                (m) => m.BankSettingsPageModule
            ),
        outlet: 'settings',
    },
    {
        ...
        loadChildren: () =>
            import(
                './reports/all-customer-outstanding-reports/all-customer-outstanding-reports.module'
            ).then((m) => m.AllCustomerOutstandingReportsPageModule),
    },
    {
        path: 'superadmin',
        loadChildren: () =>
