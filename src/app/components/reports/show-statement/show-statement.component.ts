...
export class ShowStatementComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this._commonApiService
            .getCustomerClosingBalanceStatement(this.data)
            .subscribe((data: any) => {
        ...
        this._commonApiService
            .getCustomerOpeningBalanceStatement(this.data)
            .subscribe((data: any) => {
            ...
            [
                {
                    ...
                    fromdate: `From: ${moment(this.data.startdate).format(
                        'DD/MM/YYYY'
                    )}`,
                    todate: `To: ${moment(this.data.enddate).format(
                        'DD/MM/YYYY'
                    )}`,
                },
            ],
