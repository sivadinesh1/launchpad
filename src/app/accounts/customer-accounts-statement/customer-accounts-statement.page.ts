    ...
    constructor(
        ...
        this.user_data$
            ...
            .subscribe((data: any) => {
                ...
                this.getCustomers(this.user_data.center_id);
                this.ready = 1;
        ...
        this._commonApiService
            ...
            .subscribe((data: any) => {
                ...
                this.filteredCustomer =
                    this.statementForm.controls.customerctrl.valueChanges.pipe(
                        startWith(''),
                        map((customer) =>
                            customer
    ...
    getStatement() {
        ...
        this._commonApiService
            ...
            .subscribe((data: any) => {
                ...
                if (
                    this.statementdata.length === 0 &&
                    this.statementForm.value.customerid === 'all'
                ) {
