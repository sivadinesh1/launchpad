...
export class AccountsPaymentsPage implements OnInit {
    ...
    @ViewChild('PymtOverviewTablePaginator')
    ...
    ngAfterViewInit() {
        ...
        this.pymttransactionsdataSource.paginator =
            this.pymttransactionTablePaginator;
    }
    ...
    reloadSaleInvoiceByCenter() {
        ...
        this._commonApiService
            ...
            .subscribe((data: any) => {
                ...
                this.saleInvoicedataSource.data = data.body.filter(
                    (data: any) => data.payment_status !== 'PAID'
                );
